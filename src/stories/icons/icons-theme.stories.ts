...
export const Grid: Story = {
  render: () => ({
    ...
    template: `
      <section class="min-h-screen p-6 lg:p-10 bg-page-deep">
            ...
            >
              ...
              <div class="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8">
                <article
                  ...
                  :key="name"
                  class="cursor-pointer rounded-lg border border-neutral-200/80 bg-page-surface bg-layer-body p-3 text-content-text-primary transition hover:border-primary-brand-active"
                ...
                >
                  ...
                  >
                    <div :class="group.type === 'flat' ? 'size-18' : iconWrapperClass">
                      <UiIcon :name="name" :size="group.type === 'flat' ? '72' : iconSize" class="text-page-primary"/>
                    </div>
                  </div>
                  <p class="mt-2 break-words text-center text-caption text-content-text text-page-primary">
                    {{ name }}
                  </p>
                  <p
                    v-if="copiedIconName === name"
                    class="mt-1 text-center text-caption text-page-brand"
                  >
                    Copied
                  </p>
                </article>
