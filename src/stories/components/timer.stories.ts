...
export const Playground: Story = {
  render: (args) => ({
    ...
    template: `
      <div class="bg-bg-page-deep p-16">
        <div class="flex gap-8">
          <div class="space-y-2">
            <div class="text-xs font-medium uppercase text-fg-page-primary">filled</div>
          ...
          <div class="space-y-2">
            <div class="text-xs font-medium uppercase text-fg-page-primary">ghost</div>
            <div class="inline-flex rounded-2xl bg-bg-page-surface p-8">
              <UiTimer
                variant="ghost"
                :config="timerConfig"
                :labels="args.labels"
  ...
  render: () => ({
    ...
    template: `
      <div class="space-y-6 bg-bg-page-deep p-6">
        ...
        <section class="flex gap-2 rounded-2xl border border-white/10 bg-bg-page-surface-alt p-4">
        ...
        <section class="flex gap-2 rounded-2xl bg-bg-page-surface p-4">
