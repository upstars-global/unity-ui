  ...
  render: (args) => ({
    ...
    template: `
      <div class="bg-bg-page-deep p-6">
        <div class="max-w-[420px] rounded-2xl border border-black/10 bg-bg-page-surface-alt p-4">
    ...
    template: `
      <div class="space-y-4 bg-bg-page-deep p-6">
        <section
          v-for="item in items"
          :key="item.variant"
          class="max-w-[520px] rounded-2xl border border-black/10 bg-bg-page-surface-alt p-4"
        >
