  ...
  render: (args) => ({
    ...
    template: `
      <div class="p-6 bg-bg-page-deep">
        <div class="rounded-2xl border border-neutral-100 bg-bg-page-surface p-6 shadow-sm">
          <div class="mb-4 text-title-md uppercase tracking-[0.1em] text-fg-page-primary">
          ...
          <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            <div
              ...
              :key="layout"
              class="rounded-xl border border-neutral-100 bg-bg-page-surface p-16"
            >
              <div class="mb-3 text-xs font-semibold uppercase tracking-[0.1em] text-fg-page-primary">
                {{ layout }}
              </div>
...
export const VariantsMatrix: Story = {
  ...
  render: () => ({
    ...
    template: `
      <div class="space-y-8 p-6 bg-bg-page-deep">
        <section
          v-for="layout in gridLayouts"
          :key="layout"
          class="rounded-2xl border border-black/10 bg-bg-page-surface p-5 shadow-sm"
        >
          <div class="mb-4 text-fg-page-primary">
          ...
          <div class="space-y-4">
            <div
              ...
              :key="variant"
              class="grid gap-3 rounded-xl border border-black/5 bg-bg-page-surface-alt p-4 md:grid-cols-[140px_repeat(3,minmax(0,1fr))]"
            >
              <div class="flex items-center text-sm font-medium text-fg-page-primary">
                <div>
              ...
              <div
                ...
                :key="size"
                class="flex min-h-24 flex-col items-start justify-center gap-2 rounded-lg bg-bg-page-surface px-3 py-3"
              >
                <div class="text-[11px] uppercase tracking-[0.1em] text-fg-page-primary">{{ size }}</div>
...
export const States: Story = {
  ...
  render: () => ({
    ...
    template: `
      <div class="space-y-4 p-6 bg-bg-page-deep">
        <div
          v-for="variant in variants"
          :key="variant"
          class="grid gap-3 rounded-2xl border border-black/10 bg-bg-page-surface p-4 md:grid-cols-5"
        >
          <div class="flex items-center text-sm font-medium capitalize text-fg-page-primary">{{ variant }}</div>
