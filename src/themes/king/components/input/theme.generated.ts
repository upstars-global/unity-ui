...
const button = {
    ...
    "slots": {
        ...
        "label": "text-body font-medium duration-150 text-[var(--component-input-label)] group-focus-within:text-[var(--component-input-focus-label)] group-data-[invalid=true]:text-[var(--component-input-error-label)] min-w-0 truncate",
        "value": "text-body font-medium placeholder:font-normal text-[var(--component-input-value)] placeholder:text-[var(--component-input-placeholder)] min-w-0 truncate",
