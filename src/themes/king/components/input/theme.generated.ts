...
const button = {
    ...
    "slots": {
        "field": "flex items-center w-full overflow-hidden border-solid [border:0.125rem_solid_rgb(80_80_254_/_0.4)] gap-8 bg-white hover:[&:not(:focus-within):not([data-invalid=true])]:border-primary-400/40 focus-within:border-primary-300 data-[invalid=true]:[&:not(:focus-within)]:border-error-100",
