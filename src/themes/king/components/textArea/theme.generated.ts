...
const button = {
    ...
    "size": {
        "default": {
            "field": "rounded-12 h-[3.5rem] py-8 px-12 h-auto items-start"
        }
    },
    "slots": {
        ...
        "label": "text-caption font-medium left-0 origin-left transition-all duration-200 ease-out cursor-text w-full text-body font-medium duration-150 text-neutral-400 group-data-[invalid=true]:text-error-100 group-focus-within:!text-primary-300 min-w-0 truncate",
