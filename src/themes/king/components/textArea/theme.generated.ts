...
const button = {
    ...
    "slots": {
        ...
        "label": "text-caption font-medium left-0 origin-left transition-all duration-200 ease-out w-full text-body duration-150 text-neutral-400 group-focus-within:!text-primary-300 min-w-0 truncate",
