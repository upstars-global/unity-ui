...
const button = {
    ...
    "slots": {
        ...
        "label": "pointer-events-none absolute left-0 origin-left transition-all duration-200 ease-out text-body font-medium duration-150 text-neutral-100 group-focus-within:text-primary-300 group-data-[invalid=true]:text-error-100 min-w-0 truncate",
