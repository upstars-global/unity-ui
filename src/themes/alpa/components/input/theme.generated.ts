...
const button = {
    ...
    "slots": {
        ...
        "label": "absolute left-0 origin-left transition-all duration-200 ease-out cursor-text w-full text-body font-medium duration-150 text-neutral-100 group-data-[invalid=true]:text-error-100 group-focus-within:!text-primary-300 min-w-0 truncate",
