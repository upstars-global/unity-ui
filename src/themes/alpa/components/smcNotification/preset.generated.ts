  ...
  plugins: [
    plugin(({ addBase, addComponents }) => {
      ...
      addComponents({
        '.smc-notification': {
          width: '100%',
          background: "linear-gradient(to top, rgb(var(--color-neutral-500) / 0) 0%, rgb(var(--color-neutral-500) / 0.1) 2rem, rgb(var(--color-neutral-500) / 0.8) 5rem, rgb(var(--color-neutral-500)) 100%)",
          '@screen md': {
            width: '28rem',
            background: 'none',
          },
